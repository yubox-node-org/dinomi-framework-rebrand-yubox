...
function listUsers($pACL, $smarty, $module_name, $local_templates_dir, $plugins)
{
     ...
     * información. */
    $bViewAllUsers = hasModulePrivilege($_SESSION['elastix_user'], $module_name, 'viewown');
     ...
     * información. */
    $bEditAnyUser = hasModulePrivilege($_SESSION['elastix_user'], $module_name, 'editown');
     ...
     * borrar su usuario. */
    $bDeleteAnyUser = hasModulePrivilege($_SESSION['elastix_user'], $module_name, 'deleteown');
    ...
    if (hasModulePrivilege($_SESSION['elastix_user'], $module_name, 'createown')) {
...
function editUser($pACL, $smarty, $module_name, $local_templates_dir, $plugins)
{
    ...
    $id_user_session = $pACL->getIdUser($_SESSION['elastix_user']);
    $privileged = hasModulePrivilege($_SESSION['elastix_user'], $module_name, 'editown');
